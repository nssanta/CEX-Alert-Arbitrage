...
if __name__ == "__main__":
    ...
    # Загрузка данных профилирования из файла
    stats = pstats.Stats('profile_stats.prof')  # Замените 'output_file.prof' на имя вашего файла

    # Вызов метода print_stats() с указанием имени функции для отображения информации о ней
    stats.print_stats('get_full_info')
